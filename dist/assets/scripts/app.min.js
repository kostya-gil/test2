...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _linfo = __webpack_require__(73);
	
	var _linfo2 = _interopRequireDefault(_linfo);
	
	var _masters = __webpack_require__(74);
	
	var _masters2 = _interopRequireDefault(_masters);
	
	var _examples = __webpack_require__(75);
	...
	var _calc = __webpack_require__(77);
	...
	(0, _jquery2.default)(function () {
		...
		(0, _header2.default)();
		(0, _calc2.default)();
		(0, _jquery2.default)('input[type="tel"]').mask('+7(999)999-99-99');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function feedback() {
		(0, _jquery2.default)('.review-slider').slick({
			dots: false,
			infinite: false,
			speed: 300,
			slidesToShow: 1,
			slidesToScroll: 1,
			adaptiveHeight: true,
			prevArrow: (0, _jquery2.default)('.fa-l'),
			nextArrow: (0, _jquery2.default)('.fa-r')
		});
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function linfo() {
		(0, _jquery2.default)('.linfo-slider').slick({
			dots: false,
			infinite: true,
			speed: 300,
			slidesToShow: 4,
			slidesToScroll: 1,
			prevArrow: (0, _jquery2.default)('.lia-l'),
			nextArrow: (0, _jquery2.default)('.lia-r'),
			responsive: [{
				breakpoint: 800,
				settings: {
					slidesToShow: 2,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function masters() {
		(0, _jquery2.default)('.masters-slider').slick({
			dots: false,
			infinite: false,
			speed: 300,
			slidesToShow: 1,
			slidesToScroll: 1,
			prevArrow: (0, _jquery2.default)('.ma-l'),
			nextArrow: (0, _jquery2.default)('.ma-r')
		});
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function examples() {
		(0, _jquery2.default)('.example-slider').slick({
			dots: false,
			infinite: false,
			speed: 300,
			slidesToShow: 1,
			slidesToScroll: 1,
			prevArrow: (0, _jquery2.default)('.ea-l'),
			nextArrow: (0, _jquery2.default)('.ea-r')
		});
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function header() {
		...
		(0, _jquery2.default)(document).on('click', '.nav__link', function () {
			...
			if ((0, _jquery2.default)('.menu').hasClass('active')) {
				(0, _jquery2.default)('.menu').slideUp().promise().then(function () {
					(0, _jquery2.default)('.menu').removeClass('active');
				});
			}
			(0, _jquery2.default)('html, body').animate({
				scrollTop: (0, _jquery2.default)('.' + (0, _jquery2.default)(this).attr('data-link')).offset().top - (0, _jquery2.default)('.header').outerHeight()
			}, {
				duration: 500
			});
			return false;
		...
		(0, _jquery2.default)(document).on('click', '.scrl-btn', function () {
			(0, _jquery2.default)('html, body').animate({
				scrollTop: (0, _jquery2.default)('.' + (0, _jquery2.default)(this).attr('data-link')).offset().top - (0, _jquery2.default)('.header').outerHeight()
			}, {
				duration: 500
		...
		(0, _jquery2.default)(document).ready(function () {
			if (localStorage.getItem('link') && window.location.pathname === '/') {
				(0, _jquery2.default)('[data-link=' + localStorage.getItem('link') + ']').addClass('active');
				(0, _jquery2.default)('html, body').animate({
					scrollTop: (0, _jquery2.default)('.' + localStorage.getItem('link')).offset().top - (0, _jquery2.default)('.header').outerHeight()
				}, {
					duration: 500
				});
				localStorage.removeItem('link');
		...
		(0, _jquery2.default)(document).on('click', '.menu-btn', function () {
			(0, _jquery2.default)(_this).toggleClass('active');
			var $contentClass = (0, _jquery2.default)('.menu');
			if ($contentClass.hasClass('active')) {
				$contentClass.slideUp().promise().then(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function calc() {
		var $btn = (0, _jquery2.default)('.type-btn.active');
	
		(0, _jquery2.default)(document).on('click', '.type-btn', function () {
			...
			$btn.addClass('active');
			(0, _jquery2.default)('.calc-form__content-top, .calc-form__content-bottom').each(function (i, item) {
				(0, _jquery2.default)(item).removeClass('active');
			});
			(0, _jquery2.default)('[data-type=' + $btnType + ']').each(function (i, item) {
				(0, _jquery2.default)(item).addClass('active');
			});
			(0, _jquery2.default)('html, body').animate({
				scrollTop: (0, _jquery2.default)('[data-type=' + $btnType + ']').offset().top - (0, _jquery2.default)('.header').outerHeight()
			}, {
				duration: 500
			});
			(0, _jquery2.default)('#typecalc').val($btnType);
			(0, _jquery2.default)('.select').chosen('destroy');
			(0, _jquery2.default)(".select").chosen({ width: '100%', no_results_text: 'Нет совпадений' });
			return false;
		});
	
		// calc
		var metrs = 1;
		var type = 'Косметический';
		var prices = {
			"Капитальный": 3350,
			"Косметический": 1490,
		...
		function calc(metrs, type) {
			var price = prices[type] * metrs;
			var days = String(Math.ceil(price / 3)).split('')[0];
	
			(0, _jquery2.default)('#end-price').text(price + '.-');
		...
		setInterval(function () {
			(0, _jquery2.default)('.select').chosen({ no_results_text: 'Нет совпадений' }).change(function (e) {
		...
		(0, _jquery2.default)(document).on('keyup', '.ni', function (e) {
			if (e.target.value) {
